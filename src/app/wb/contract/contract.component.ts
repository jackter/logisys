...
import { DetailContractFormDialogComponent } from './dialog/detail';
...
export class ContractComponent implements OnInit {
    ...
    */
    ...
    getContextMenuItems(params) {
        ...
        if (get.parent.perm.edit && !data.total_netto) {
            menu.push({
                name: 'Edit',
                action: function () {
        ...
        if (get.parent.perm.hapus && !data.total_netto) {
            menu.push('separator');
            menu.push({
                name: 'Delete',
                action: function () {
    ...
    */
     ...
     * Dialog Detail
     */
    dialogDetail: MatDialogRef<DetailContractFormDialogComponent>;
