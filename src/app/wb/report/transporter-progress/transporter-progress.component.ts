...
@Component({
    selector: 'app-transporter-progress',
    templateUrl: './transporter-progress.component.html',
    styleUrls: ['./transporter-progress.component.scss'],
    animations: fuseAnimations
})
export class TransporterProgressComponent implements OnInit {

    ComUrl = "e/wb/report/transporter/";

    public Com: any = {
        name: 'Transporter Data',
