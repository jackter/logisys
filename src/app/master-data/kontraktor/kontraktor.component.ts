...
import { KontraktorFormDialogComponent } from './dialog/form';
import { KontraktorFormAkunDialogComponent } from './dialog/form_akun';

@Component({
    selector: 'app-kontraktor',
    templateUrl: './kontraktor.component.html',
    styleUrls: ['./kontraktor.component.scss'],
    animations: fuseAnimations
})
export class KontraktorComponent implements OnInit {

    form: any = {};
    ComUrl = 'e/master/kontraktor/';
    public Com: any = {
        name: 'Kontraktor',
        title: 'List Kontraktor',
     ...
     * Form Dialog
     */
    dialogRef: MatDialogRef<KontraktorFormDialogComponent>;
     ...
     * Account
     */
    dialogCOA: MatDialogRef<KontraktorFormAkunDialogComponent>;
    ...
    Account(data) {
        ...
        Com.title = 'Form Kontraktor Account';
