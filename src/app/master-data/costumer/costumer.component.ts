...
import { CostumerFormDialogComponent } from './dialog/form';
import { CustomerFormAkunDialogComponent } from './dialog/form_akun';
...
export class CostumerComponent implements OnInit {
	...
	* Form Dialog
	*/
    dialogRef: MatDialogRef<CostumerFormDialogComponent>;
     ...
     * Account
     */
    dialogCOA: MatDialogRef<CustomerFormAkunDialogComponent>;
    ...
    Account(data) {
        ...
        Com.title = 'Form Customer Account';
