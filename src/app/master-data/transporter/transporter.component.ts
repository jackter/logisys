...
import { TransporterFormDialogComponent } from './dialog/form';
import { TransporterFormAkunDialogComponent } from './dialog/form_akun';
...
export class TransporterComponent implements OnInit {
    ...
    form: any = {};
    ComUrl = 'e/master/transporter/';
    public Com: any = {
        name: 'Transporter',
        title: 'List Transporter',
        icon: 'how_to_reg',
    };
    ...
    * Form Dialog
    */
    dialogRef: MatDialogRef<TransporterFormDialogComponent>;
     ...
     * Account
     */
    dialogCOA: MatDialogRef<TransporterFormAkunDialogComponent>;
    ...
    Account(data) {
        ...
        Com.title = 'Form Transporter Account';
