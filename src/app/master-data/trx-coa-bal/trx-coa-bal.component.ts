...
import { TrxBalFormDialogComponent } from './dialog/form';
import { fuseAnimations } from 'fuse/animations';
import swal from 'sweetalert2';

@Component({
    selector: 'app-trx-coa-bal',
    templateUrl: './trx-coa-bal.component.html',
    styleUrls: ['./trx-coa-bal.component.scss'],
    animations: fuseAnimations
})
export class TrxCoaBalComponent implements OnInit {
    ComUrl = "e/master/trx_coa_bal/";
    form: any = {};

    public Com: any = {
        name: 'Trx COA Bal Data',
   ...
   */
    ...
    * Form Dialog
    */
    dialogRef: MatDialogRef<TrxBalFormDialogComponent>;
