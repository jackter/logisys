...
import { VehicleFormDialogComponent } from './dialog/form';
...
export class VehicleComponent implements OnInit {
        ...
        this.core.Do(this.ComUrl + 'default', {}).subscribe(
            result => {
                ...
                if (result) {
                    ...
                    this.Default.vehicle = result.vehicle;
                }
    ...
    TableCol = [
        ...
        {
            headerName: 'Tipe Kendaraan',
            field: 'vgrup_nama',
            suppressSizeToFit: true,
            width: 175
        },
        {
            headerName: 'No. Kendaraan',
            field: 'nopol',
            suppressSizeToFit: true,
            width: 175
        },
     ...
     * Form Dialog
     */
    dialogRef: MatDialogRef<VehicleFormDialogComponent>;
