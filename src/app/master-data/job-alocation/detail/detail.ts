...
import { JobAlocationFormDialogComponent } from './dialog/form';

@Component({
    selector: 'job-alocation-detail',
    templateUrl: './detail.html',
    animations: fuseAnimations
})
export class JobAlocationDetailComponent implements OnInit {
   ...
   */
     ...
     * Form Dialog
     */
    dialogRef: MatDialogRef<JobAlocationFormDialogComponent>;
