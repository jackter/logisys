...
import { InvoiceDPFormDialogComponent } from './dialog/form';
import { InvoiceDPPrintDialogComponent } from './dialog/print';

@Component({
    selector: 'app-invoice-dp',
    templateUrl: './invoice-dp.component.html',
    styleUrls: ['./invoice-dp.component.scss'],
    animations: fuseAnimations
})
export class InvoiceDPComponent implements OnInit {

    ComUrl = "e/accounting/invoice/dp/";
    public Com: any = {
        name: 'Invoice Others',
        title: 'Invoice Others Lists',
        icon: 'shopping_cart',
    };
    ...
    */
     ...
     * Form Dialog
     */
    dialogRef: MatDialogRef<InvoiceDPFormDialogComponent>;
    ...
    * Print Invoice
    */
    dialogPrint: MatDialogRef<InvoiceDPPrintDialogComponent>;
