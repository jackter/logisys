...
@Component({
    selector: 'dialog-print-pengeluaran',
    templateUrl: './print2.html',
    styleUrls: ['../bank-payment.component.scss']
})
export class PengeluaranDialogPrintComponent implements OnInit {
    ...
    constructor(
        private core: Core,
        public dialogRef: MatDialogRef<PengeluaranDialogPrintComponent>
    ) { }
    ...
    ngOnInit() {
        ...
        this.form.debit_show = this.core.rupiah(this.form.total);
