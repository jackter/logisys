...
import { TBSummaryDialogComponent } from './dialog/detail';
import { TBSummaryPrintDialogComponent } from './dialog/print';
...
@Component({
  selector: 'app-trial-balance-summary',
  templateUrl: './trial-balance-summary.component.html',
  styleUrls: ['./trial-balance-summary.component.scss'],
...
export class TrialBalanceSummaryComponent implements OnInit {

    form: any = {};
    ComUrl = "e/accounting/report/tb-summary/";
    ...
    ngOnInit() {
        var Filter = this.LS.get('TBSummaryFilter');
        if (Filter) {
            this.filter = Filter;
        } else {
    ...
    },
    {
        ...
        cellStyle: function (params) {
            ...
            if (params.data.has_child || params.data.is_total) {
    ...
    LoadData(params) {
        ...
        if (this.filter) {
            this.LS.set('TBSummaryFilter', JSON.parse(JSON.stringify(this.filter)));
        }
    ...
    RowStyle(params) {
        ...
        if (params.data) {
            ...
            if (params.data.has_child == 1 || params.data.is_total == 1) {
                Style.fontWeight = 'bold';
            }
    ...
    //  * Detail Dialog
    //  */
    dialogDetail: MatDialogRef<TBSummaryDialogComponent>;
     ...
     */
    GTotal : any = [];
    dialogPrint: MatDialogRef<TBSummaryPrintDialogComponent>;
    ...
    Print() {
        ...
        this.dialogPrint.componentInstance.GTotal = this.GTotal;
