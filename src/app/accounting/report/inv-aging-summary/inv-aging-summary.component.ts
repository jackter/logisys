...
import { PrintInvAgingSummaryDialogComponent } from './dialog/print';

@Component({
    selector: 'app-inv-aging-summary',
    templateUrl: './inv-aging-summary.component.html',
    styleUrls: ['./inv-aging-summary.component.scss'],
    animations: fuseAnimations
})
export class InvAgingSummaryComponent implements OnInit {

    form: any = {};
    ComUrl = "e/accounting/report/inv-aging-summary/";
    public Com: any = {
                    ...
                    if(result) {
                        ...
                        for(let item of GSupplier) {
                            ...
                            Data.push({
                                ...
                                supplier_kode: item[0].supplier_kode,
                                supplier_nama: item[0].supplier_nama,
                        ...
                        var OrderData = _.orderBy(Data, 'supplier_nama', ['asc']);
    ...
    dialogPrint: MatDialogRef<PrintInvAgingSummaryDialogComponent>;
