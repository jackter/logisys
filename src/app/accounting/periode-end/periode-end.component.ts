...
import { PeriodeEndFormDialogComponent } from './dialog/form';
import * as moment from 'moment';

@Component({
    selector: 'app-periode-end',
    templateUrl: './periode-end.component.html',
    styleUrls: ['./periode-end.component.scss'],
    animations: fuseAnimations
})
export class PeriodeEndComponent implements OnInit {
    form: any = {};
    ComUrl = "e/accounting/periode-end/";
    public Com: any = {
        name: 'Periode End',
        title: 'Periode End List',
        icon: 'calendar_today',
    };
   ...
   * Form Dialog
   */
    dialogRef: MatDialogRef<PeriodeEndFormDialogComponent>;
