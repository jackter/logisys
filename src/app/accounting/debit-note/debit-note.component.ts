...
import { DebitNoteFormDialogComponent } from './dialog/form';
import { DNPrintFormDialogComponent } from './dialog/print';
...
export class DebitNoteComponent implements OnInit {
    ...
    form: any = {};
    ComUrl = "e/accounting/invoice/debit_note/";
    public Com: any = {
        name: 'Debit Note',
        title: 'Debit Note Lists',
        icon: 'class',
    };
    ...
    * Form Dialog
    */
    dialogRef: MatDialogRef<DebitNoteFormDialogComponent>;
    ...
    PrintRef: MatDialogRef<DNPrintFormDialogComponent>;
