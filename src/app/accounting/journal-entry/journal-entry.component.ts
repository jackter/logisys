...
import { JournalFormDialogComponent } from './dialog/form';
import swal from 'sweetalert2';
import * as moment from 'moment';
import { ImportJVDialogComponent } from './dialog/import';
...
export class JournalEntryComponent implements OnInit {
    ...
    form: any = {};
    ComUrl = "e/accounting/journal-entry/";
    public Com: any = {
        name: 'Journal Voucher',
        title: 'Journal Voucher Data',
        icon: 'library_books',
    };
   ...
   * Form Dialog
   */
    dialogRef: MatDialogRef<JournalFormDialogComponent>;
    ...
    */
     ...
     * Dialog Import
     */
    dialogImport: MatDialogRef<ImportJVDialogComponent>;
    dialogImportConfig: MatDialogConfig = {
        disableClose: true,
        panelClass: 'event-form-dialog-full'
    }
    Import(){

        this.dialogImport = this.dialog.open(
            ImportJVDialogComponent,
            this.dialogImportConfig
        );

        this.dialogImport.componentInstance.Default = this.Default;
        this.dialogImport.componentInstance.ComUrl = this.ComUrl;
        this.dialogImport.componentInstance.perm = this.perm;

        //=> After Close
        this.dialogImport.afterClosed().subscribe(result => {
            this.dialogImport = null;
    ...
    DownloadTpl(){
        var Download = this.Default.files.tpl;
        
        if(this.Default.files.tpl){
