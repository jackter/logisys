...
import { SalesOrderFormDialogComponent } from './dialog/form';
...
export class SalesOrderComponent implements OnInit {
   ...
   */
    ...
    */
    ...
    TableCol = [
        ...
        },
        {
            ...
            suppressSizeToFit: true,
            valueGetter(params) {
                if (params.data.qty_so) {
                    var get = params.context;

                    return get.parent.core.rupiah(params.data.qty_so) + ' ' + params.data.item_satuan;
                }
            },
            cellStyle(params) {
                if (params.data) {
        ...
        //         if(params.data.grand_total) {
        //             return params.data.currency + ' ' +get.parent.core.rupiah(params.data.grand_total);
        //         }
        //     },
        //     cellStyle (params) {
        //         if (params.data) {
    ...
    * Form Dialog
    */
    dialogRef: MatDialogRef<SalesOrderFormDialogComponent>;
