...
import { ContractInvoiceFormDialogComponent } from './dialog/form';
...
export class ContractInvoiceComponent implements OnInit {
    ...
    ComUrl = 'e/contract/contract-invoice/';
    ...
    public Com: any = {
        name: 'Contract Invoice Standard',
        title: 'List Contract Invoice Standard',
        icon: 'description',
    };
     ...
     * Form Dialog
     */
    dialogRef: MatDialogRef<ContractInvoiceFormDialogComponent>;
