...
import { ContractInvoiceDpFormDialogComponent } from './dialog/form';

@Component({
    selector: 'app-contract-invoice-dp',
    templateUrl: './contract-invoice-dp.component.html',
    styleUrls: ['./contract-invoice-dp.component.scss'],
    animations: fuseAnimations
})
export class ContractInvoiceDpComponent implements OnInit {

    ComUrl = 'e/contract/contract-invoice-others/';
    ...
    public Com: any = {
        name: 'Contract Invoice Others',
        title: 'List Contract Invoice Others',
        icon: 'description',
    };
            ...
            valueGetter(params) {
                if (params.data) {
                    ...
                    if (params.data.verified == 1 && params.data.approved != 1) {
                        return 'VERIFIED, WAITING APPROVAL';
                    }
                    if (params.data.approved == 1) {
                        return 'APPROVED';
                    }
     ...
     * Form Dialog
     */
    dialogRef: MatDialogRef<ContractInvoiceDpFormDialogComponent>;
            ...
            this.core.Do(this.ComUrl + 'get', Params).subscribe(
                result => {
                    ...
                    if (result) {
                        ...
                        this.form.kontrak = result.kontrak;
                        if (isDetail) {
