...
import { JO2FormDialogComponent } from './dialog/form';
import swal from 'sweetalert2';
import { FuseConfigService } from 'fuse/services/config.service';

@Component({
    selector: 'app-jo',
    templateUrl: './jo2.component.html',
    styleUrls: ['./jo2.component.scss'],
    animations: fuseAnimations
})
export class JO2Component implements OnInit {

    ComUrl = 'e/manufacturing/jo2/';
   ...
   */
    ...
    */
     ...
     * Open Form
     */
    dialogRef: MatDialogRef<JO2FormDialogComponent>;
