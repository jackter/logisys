...
import { MaterialReturnReceiveFormDialogComponent } from './dialog/form';

@Component({
    selector: 'app-material-return-receive',
    templateUrl: './material-return-receive.component.html',
    styleUrls: ['./material-return-receive.component.scss'],
    animations: fuseAnimations
})
export class MaterialReturnReceiveComponent implements OnInit {

    ComUrl = 'e/manufacturing/material-return-receive/';
    ...
    public Com: any = {
        name: 'Material Return Receive',
        title: 'Material Return Receive Lists',
        icon: 'refresh'
    };
    ...
    * Form Dialog
    */
    dialogRef: MatDialogRef<MaterialReturnReceiveFormDialogComponent>;
            ...
            this.core.Do(this.ComUrl + 'get', Params).subscribe(
                result => {
                    ...
                    if (result) {
                        ...
                        this.form.list = result.data.detail;
                        if (isDetail) {
