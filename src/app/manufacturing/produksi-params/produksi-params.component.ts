...
import { PPFormDialogComponent } from './dialog/form';
import swal from 'sweetalert2';

@Component({
    selector: 'app-produksi-params',
    templateUrl: './produksi-params.component.html',
    styleUrls: ['./produksi-params.component.scss'],
    animations: fuseAnimations
})
export class ProduksiParamsComponent implements OnInit {

    ComUrl = "e/manufacturing/pp/";
   ...
   */
    ...
    * Form Dialog
    */
    dialogRef: MatDialogRef<PPFormDialogComponent>;
