...
@Component({
    selector: 'app-fg2',
    templateUrl: './fg2.component.html',
    styleUrls: ['./fg2.component.scss'],
    animations: fuseAnimations
})
export class Fg2Component implements OnInit {
   ...
   */
    ...
    */
    ...
    TableCol = [
        ...
        },
        {
            ...
            valueGetter(params) {
                if(params.data) {
                    if(params.data.storeloc) {
                        return params.data.storeloc_kode + ' - ' + params.data.storeloc_nama;
                    }
                }
            }
        },
    ...
    */
    onClick(params) {
        this.router.navigate(['/manufacturing/transfer_finish_goods2/transfer/' + params.data.id]);
    }
    onDoubleClick(params) {}
    // => / END : Click
