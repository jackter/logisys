...
import { MaterialReturnFormDialogComponent } from './dialog/form';
...
export class MaterialReturnComponent implements OnInit {
    ...
    ComUrl = 'e/manufacturing/material-return/';
    ...
    public Com: any = {
        name: 'Material Return Delivery',
        title: 'Material Return Delivery Lists',
        icon: 'refresh'
    };
    ...
    * Form Dialog
    */
    dialogRef: MatDialogRef<MaterialReturnFormDialogComponent>;
