...
import { JOPrintDialogComponent } from './print';
...
export class JOFormDialogComponent implements OnInit {
    ...
    constructor(
        ...
        private dialogRef: MatDialogRef<JOFormDialogComponent>
    ...
    CalculateQty() {
        ...
        this.Delay = setTimeout(() => {
            ...
            this.form.order_qty = this.core.rupiah(this.Output[0].ref_qty * Count, 2, true) + ' ' + this.Output[0].satuan;
 ...
 */
     ...
     * Print JO
     */
    dialogPrint: MatDialogRef<JOPrintDialogComponent>;
