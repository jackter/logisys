...
import { MRPrintDialogComponent } from './print';
import { MRRejectFormDialogComponent } from './reject';
...
export class MRFormDialogComponent implements AfterViewInit {
    ...
    constructor(
        ...
        public dialogRef: MatDialogRef<MRFormDialogComponent>
    ) { }
     ...
     * Print MR
     */
    dialogPrint: MatDialogRef<MRPrintDialogComponent>;
     ...
     * Reject MR
     */
    dialogReject: MatDialogRef<MRRejectFormDialogComponent>;
