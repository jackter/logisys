...
@Component({
    selector: 'app-report-rgr',
    templateUrl: './report-rgr.component.html',
    styleUrls: ['./report-rgr.component.scss'],
    animations: fuseAnimations
})
export class ReportRgrComponent implements OnInit {

    form: any = {};
    ComUrl = "e/snd/report/rgr/";
    public Com: any = {
        name: 'Report Return Goods Receive',
        title: 'Report Return Goods Receive List',
        icon: 'refresh',
    };
 ...
 */
    ...
    TableCol = [
        ...
        {
            headerName: 'QTY ACT Receive',
            field: 'act_qty_receipt',
            width: 100,
            suppressSizeToFit: true,
