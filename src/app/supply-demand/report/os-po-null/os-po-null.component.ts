...
@Component({
    selector: 'app-os-po-null',
    templateUrl: './os-po-null.component.html',
    styleUrls: ['./os-po-null.component.scss'],
    animations:fuseAnimations
})
export class OsPoNullComponent implements OnInit {

    ComUrl = 'e/snd/report/os-po-null/';
