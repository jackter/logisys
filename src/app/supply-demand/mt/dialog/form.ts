...
export class MTFormDialogComponent implements OnInit {
    ...
    constructor(
        private core: Core,
        public dialogRef: MatDialogRef<MTFormDialogComponent>
    ) {
    ...
    CompanySelect(e, item) {
        if (e.isUserInput) {
            ...
            this.FStore = item.store;
            this.FStoreKeep = item.store;
