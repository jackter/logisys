...
import { MTOFormDialogComponent } from './dialog/form';
import swal from 'sweetalert2';
import { BroadcasterService } from 'ng-broadcaster';
import { Router } from '@angular/router';
import * as moment from 'moment';
import { MTOPrintDialogComponent } from './dialog/print';

@Component({
	selector: 'app-mto',
	templateUrl: './mto.component.html',
	styleUrls: ['./mto.component.scss'],
	animations: fuseAnimations
})
export class MtoComponent implements OnInit {

	form: any = {};
    orm: any = {};
    ComUrl = 'e/snd/mto/';
    public Com: any = {
        name: 'Material Transfer Out',
    ...
    onDoubleClick(params) {
        if(params.data.approved == 1){
            this.OpenDetail('detail-' + params.data.id);
        }else{
     ...
     * Form Dialog
     */
    dialogRef: MatDialogRef<MTOFormDialogComponent>;
     ...
     * Show Print
     */
    dialogDetail: MatDialogRef<MTOPrintDialogComponent>;
    ...
    ShowDetail() {
        ...
        this.dialogDetail.componentInstance.Title = this.Data.kode;
        this.dialogDetail.componentInstance.Data = this.Data;
