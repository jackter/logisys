...
import { ReportItemDetailDialogComponent } from './dialog/detail';
    ...
    getContextMenuItems(params) {
        ...
        menu.push({
            ...
            action: function () {
                ...
                var FileName = get.parent.filter.company_abbr + ' (' + get.parent.filter.storeloc_kode + ') - ' + get.parent.filter.fdari + ' - ' + get.parent.filter.fhingga + ' ' + moment(new Date()).format('DD-MM-YYYY');
                if (!get.parent.filter.storeloc_kode) {
                    FileName = get.parent.filter.company_abbr + ' - ' + get.parent.filter.fdari + ' - ' + get.parent.filter.fhingga + ' ' + moment(new Date()).format('DD-MM-YYYY');
                }

                var params = {
                    columnGroups: true,
                    fileName: 'Item Stock ' + FileName,
                    sheetName: 'Item Stock'
                };
