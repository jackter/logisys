...
@Component({
    selector: 'app-pengeluaran-barang',
    templateUrl: './pengeluaran-barang.component.html',
    styleUrls: ['./pengeluaran-barang.component.scss'],
    animations: fuseAnimations

})
export class PengeluaranBarangComponent implements OnInit {

    form: any = {};
    ComUrl = 'e/stock/report/pengeluaran/';
    public Com: any = {
        name: 'Report Goods Issued',
        title: 'Report Goods Issued List',
        icon: 'list',
    };
        ...
        },
        {
            ...
            valueFormatter: function (params) {
                if (params.data) {
                    ...
                    if($this.perm.view_price){
                        if (params.value) {
                            return $this.core.rupiah(Number(params.value) * Number(params.data.qty_gi), 2, true);
                        }else{
                            return '-';
                        }
                    }else{
