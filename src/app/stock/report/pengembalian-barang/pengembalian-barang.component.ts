...
@Component({
    selector: 'app-pengembalian-barang',
    templateUrl: './pengembalian-barang.component.html',
    styleUrls: ['./pengembalian-barang.component.scss'],
    animations: fuseAnimations
})
export class PengembalianBarangComponent implements OnInit {

    form: any = {};
    ComUrl = 'e/stock/report/pengembalian/';
    public Com: any = {
        name: 'Report Return Goods Issued',
        title: 'Report Return Goods Issued List',
        icon: 'refresh',
    };
    ...
    TableCol = [
        ...
        {
            headerName: 'QTY ACT ISSUED',
            field: 'act_qty_issued',
            width: 100,
            suppressSizeToFit: true,
