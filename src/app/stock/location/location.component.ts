...
import { LocationFormDialogComponent } from './dialog/form';
...
export class LocationComponent implements OnInit {
    ...
    LoadDefault() {
        ...
        this.core.Do(this.ComUrl + 'default', Params).subscribe(
            result => {
                ...
                if (result.params.product_storage) {
                    this.Default.product = JSON.parse(JSON.stringify(result.params.product_storage.value));
                }
     ...
     * Form Dialog
     */
    dialogRef: MatDialogRef<LocationFormDialogComponent>;
