...
import { TakingFormDialogComponent } from './dialog/form';

@Component({
    selector: 'app-taking',
    templateUrl: './taking.component.html',
    styleUrls: ['./taking.component.scss'],
    animations: fuseAnimations
})
export class TakingComponent implements OnInit {

    ComUrl = 'e/stock/taking/';
    form: any = {};
    orm: any = {};
     ...
     * Form Dialog
     */
    dialogRef: MatDialogRef<TakingFormDialogComponent>;
