...
if ($R_Data > 0) {
    ...
    $return['data']['cost_center_id'] = $Cost['cost_center_id'];
    $return['data']['cost_center_kode'] = $Cost['cost_center_kode'];
    $return['data']['cost_center_nama'] = $Cost['cost_center_nama'];
    ...
    if ($R_Detail > 0) {
        ...
        while ($Detail = $DB->Result($Q_Detail)) {
            ...
            if ($Detail['tipe'] == 1) {
                ...
                if ($Data['approved'] == 1 && $Detail['qty_req'] > 0) {
    ...
    $return['data']['unapproved'] = $CountUnapproved;
}
